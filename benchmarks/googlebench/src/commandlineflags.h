...
// returns the given default value.
    bool BoolFromEnv(const char* flag,
                     bool default_val);
...
// the given default value.
    int32_t Int32FromEnv(const char* flag,
                         int32_t default_val);
...
// the given default value.
    double DoubleFromEnv(const char* flag,
                         double default_val);
...
// the given default value.
    const char* StringFromEnv(const char* flag,
...
// On success, stores the value of the flag in *value, and returns
// true.  On failure, returns false without changing *value.
    bool ParseDoubleFlag(const char* str,
                         const char* flag,
                         double* value);
