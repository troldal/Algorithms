...
//=============================================================================//
        ...
        Benchmark* Benchmark::Range(int64_t start,
                                    int64_t limit) {
            CHECK(ArgsCnt() == -1 || ArgsCnt() == 1);
        ...
        Benchmark* Benchmark::DenseRange(int64_t start,
                                         int64_t limit,
                                         int step) {
            CHECK(ArgsCnt() == -1 || ArgsCnt() == 1);
        ...
        Benchmark* Benchmark::ThreadRange(int min_threads,
                                          int max_threads) {
        ...
        Benchmark* Benchmark::DenseThreadRange(int min_threads,
                                               int max_threads,
                                               int stride) {
            CHECK_GT(min_threads, 0);
            CHECK_GE(max_threads, min_threads);
