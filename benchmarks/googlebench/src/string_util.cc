...
// We require that all three arrays have the same size.
        ...
        void ToExponentAndMantissa(double val,
                                   double thresh,
                                   int precision,
                                   double one_k,
                                   std::string* mantissa,
        ...
        std::string ExponentToPrefix(int64_t exponent,
                                     bool iec) {
            if (exponent == 0)
                return "";
        ...
        std::string ToBinaryStringFullySpecified(double value,
                                                 double threshold,
                                                 int precision,
                                                 double one_k = 1024.0) {
            std::string mantissa;
    ...
    void AppendHumanReadable(int n,
                             std::string* str) {
        std::stringstream ss;
    ...
    std::string StrFormatImp(const char* msg,
                             va_list args) {
