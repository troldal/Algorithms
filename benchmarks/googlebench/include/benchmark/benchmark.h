...
// Returns true there is at least on unrecognized argument (i.e. 'argc' > 1).
    bool ReportUnrecognizedArguments(int argc,
                                     char** argv);
...
// benchmark to use.
    ...
    private:
        ...
        bool KeepRunningInternal(IterationCount n,
                                 bool is_batch);
...
// chained into one expression.
        ...
        public:
            ...
            Benchmark* RangePair(int64_t lo1,
                                 int64_t hi1,
                                 int64_t lo2,
                                 int64_t hi2) {
            ...
            Benchmark* ComputeStatistics(std::string name,
...
// (ie those created using the BENCHMARK(...) macros.
        ...
        {
        public:
            FunctionBenchmark(const char* name,
                              Function* func)
...
// The reporter object must implement the following interface.
    ...
    public:
        ...
        static void PrintBasicContext(std::ostream* out,
